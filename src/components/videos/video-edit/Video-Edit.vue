<template>
    <div>
        ...
        <button v-on:click="edit" type="submit" class="btn btn-primary btn-md align-items-md text-white">Edit</button>
        </div>
        </form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getVideo() {
            VideoService.getVideoById(this.$route.params.videoId)
            .then((doc) => {
